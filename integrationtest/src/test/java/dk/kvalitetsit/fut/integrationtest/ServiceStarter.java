package dk.kvalitetsit.fut.integrationtest;

import com.github.dockerjava.api.model.VolumesFrom;
import dk.kvalitetsit.fut.Application;
...
public class ServiceStarter {
    ...
    private static final Logger serviceLogger = LoggerFactory.getLogger("fut-patient-bff");
    ...
    public GenericContainer<?> startServicesInDocker() {
        ...
        var resourcesContainerName = "fut-patient-bff-resources";
        ...
        if (resourcesRunning) {
            ...
            service = new GenericContainer<>("local/fut-patient-bff-qa:dev")
        ...
        service.withNetwork(dockerNetwork)
                .withNetworkAliases("fut-patient-bff")
